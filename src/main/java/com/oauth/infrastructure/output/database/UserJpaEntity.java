...
public class UserJpaEntity implements UserDetails {
    ...
    public UserJpaEntity(String username, String email, String password, String fullName,
            Boolean enabled, Set<RoleJpaEntity> roles, LocalDateTime createdAt, LocalDateTime lastPasswordChangeAt) {
